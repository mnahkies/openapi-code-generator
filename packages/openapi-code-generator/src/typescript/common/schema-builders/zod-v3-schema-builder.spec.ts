...
describe.each(
  ...
  describe("numbers", () => {
    ...
    it("supports exclusiveMinimum", async () => {
      ...
      await expect(execute(4)).rejects.toThrow("Number must be greater than 4")
      await expect(execute(20)).resolves.toBe(20)
    })
