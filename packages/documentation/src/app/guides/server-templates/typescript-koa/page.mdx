...
```sh npm2yarn
npm i --save-dev @nahkies/openapi-code-generator @types/koa
...
### Middleware
Each `createRouter` function accepts an optional `options: {middleware: RouterMiddleware[]}` parameter. You can use this
