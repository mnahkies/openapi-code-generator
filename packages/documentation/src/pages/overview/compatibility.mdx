...
| [servers](#server-object)        |     ✅     |                 Server URLs cam be usd to type client SDK base paths |
| [paths](#paths-object)           |     ✅     |                                                                      |
...
### Request Body Object
Well-supported for `application/json` content types. Support for form data, and file uploads, etc
