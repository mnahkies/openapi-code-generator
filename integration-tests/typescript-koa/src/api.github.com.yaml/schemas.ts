...
export const s_code_scanning_alert = z.object({
  ...
  fixed_at: z.coerce.string().datetime({ offset: true }).optional().nullable(),
  dismissed_by: z
    .object({
      name: z.coerce.string().optional().nullable(),
      email: z.coerce.string().optional().nullable(),
    ...
    .nullable(),
  dismissed_at: z.coerce.string().datetime({ offset: true }).nullable(),
  dismissed_reason: z
    .enum(["null", "false positive", "won't fix", "used in tests"])
    .nullable(),
  dismissed_comment: z.coerce.string().optional().nullable(),
  rule: z.object({
  ...
  tool: z.object({
    ...
    guid: z.coerce.string().optional().nullable(),
  }),
  most_recent_instance: z.object({
    ...
    html_url: z.coerce.string().optional(),
    classifications: z
      .array(z.enum(["source", "generated", "test", "library"]).nullable())
      .optional(),
  }),
})
...
export const s_dependabot_alert = z.object({
    ...
    vulnerabilities: z.array(
      z.object({
        ...
        first_patched_version: z
          .object({ identifier: z.coerce.string() })
          .nullable(),
      })
    ),
    severity: z.enum(["low", "medium", "high", "critical"]),
  ...
  fixed_at: z.coerce.string().datetime({ offset: true }).nullable(),
})
