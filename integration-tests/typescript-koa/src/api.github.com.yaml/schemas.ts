...
export const s_marketplace_account = z.object({
  ...
  organization_billing_email: z.string().email().optional().nullable(),
})
...
export const s_private_user = z.object({
  ...
  plan: z
    ...
    .optional(),
  suspended_at: z.string().datetime({ offset: true }).optional().nullable(),
...
export const s_minimal_repository = z.object({
  ...
  pushed_at: z.string().datetime({ offset: true }).optional().nullable(),
  ...
  vulnerabilities: z
    .array(
      z.object({
        ...
        vulnerable_version_range: z.string().optional().nullable(),
        patched_versions: z.string().optional().nullable(),
        vulnerable_functions: z.array(z.string()).optional().nullable(),
      }),
    )
    .optional()
    .nullable(),
  cwe_ids: z.array(z.string()).optional().nullable(),
  severity: z.enum(["critical", "high", "medium", "low"]).optional().nullable(),
  cvss_vector_string: z.string().optional().nullable(),
})
...
export const s_repository_advisory_update = z.object({
  ...
  collaborating_users: z.array(z.string()).optional().nullable(),
  collaborating_teams: z.array(z.string()).optional().nullable(),
})
...
export const s_copilot_seat_details = z.object({
  ...
  pending_cancellation_date: z.string().optional().nullable(),
  last_activity_at: z.string().datetime({ offset: true }).optional().nullable(),
  last_activity_editor: z.string().optional().nullable(),
  created_at: z.string().datetime({ offset: true }),
  updated_at: z.string().datetime({ offset: true }).optional(),
})
...
export const s_issue = z.object({
  ...
  pull_request: z
    .object({
      merged_at: z.string().datetime({ offset: true }).optional().nullable(),
...
export const s_timeline_cross_referenced_event = z.object({
  ...
  created_at: z.string().datetime({ offset: true }),
  updated_at: z.string().datetime({ offset: true }),
  source: z.object({ type: z.string().optional(), issue: s_issue }),
})
