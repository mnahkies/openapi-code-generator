...
export const _DELETE =
  (implementation: DeleteSubscriptionsSubscriptionExposedId) =>
  async (
    request: NextRequest,
...
export const _GET =
  (implementation: GetSubscriptionsSubscriptionExposedId) =>
  async (
    request: NextRequest,
    { params }: { params: unknown },
  ): Promise<Response> => {
...
export const _POST =
  (implementation: PostSubscriptionsSubscriptionExposedId) =>
  async (
    request: NextRequest,
    { params }: { params: unknown },
  ): Promise<Response> => {
