...
export class ApiClientServersOperations {
  ...
  ): { build: () => Server<"reposUploadReleaseAsset_ApiClient"> } {
    switch (url) {
      case "https://uploads.github.com":
        return {
          build(): Server<"reposUploadReleaseAsset_ApiClient"> {
            return "https://uploads.github.com" as Server<"reposUploadReleaseAsset_ApiClient">
          },
        }
  ...
  static server(url: "https://api.github.com" = "https://api.github.com"): {
    ...
    switch (url) {
      case "https://api.github.com":
        return {
          build(): Server<"ApiClient"> {
            return "https://api.github.com" as Server<"ApiClient">
          },
        }
...
export class ApiClient extends AbstractFetchClient {
  ...
  async reposUploadReleaseAsset(
    ...
    basePath:
      | Server<"reposUploadReleaseAsset_ApiClient">
      | string = ApiClientServers.operations.reposUploadReleaseAsset().build(),
    timeout?: number,
    opts: RequestInit = {},
  ...
  async activityListReposStarredByUser(
    ...
    timeout?: number,
    opts: RequestInit = {},
  ): Promise<Res<200, t_starred_repository[] | t_repository[]>> {
