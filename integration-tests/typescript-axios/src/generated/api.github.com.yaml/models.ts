...
export type t_api_overview = {
  ...
  commit_signing_keys?: string[] | undefined
...
export type t_app_permissions = {
  ...
  artifact_metadata?: ("read" | "write" | UnknownEnumStringValue) | undefined
  attestations?: ("read" | "write" | UnknownEnumStringValue) | undefined
  checks?: ("read" | "write" | UnknownEnumStringValue) | undefined
  code_quality?: ("read" | "write" | UnknownEnumStringValue) | undefined
  ...
  discussions?: ("read" | "write" | UnknownEnumStringValue) | undefined
  ...
  merge_queues?: ("read" | "write" | UnknownEnumStringValue) | undefined
...
export type t_assigned_issue_event = {
  ...
  event: string
  id: number
  intent?: t_nullable_issue_event_intent | undefined
  node_id: string
...
export type t_billing_ai_credit_usage_report_org = {
...
export type t_billing_ai_credit_usage_report_user = {
  model?: string | undefined
  product?: string | undefined
  timePeriod: {
    day?: number | undefined
...
export type t_blocked_by_added_issue_event = {
  actor: t_simple_user
  blocked_by: t_nullable_issue_reference
  commit_id: string | null
  commit_url: string | null
  created_at: string
  event: string
...
export type t_blocked_by_removed_issue_event = {
  actor: t_simple_user
  blocked_by: t_nullable_issue_reference
  commit_id: string | null
  commit_url: string | null
...
export type t_blocking_added_issue_event = {
  actor: t_simple_user
  blocking: t_nullable_issue_reference
  commit_id: string | null
  commit_url: string | null
  created_at: string
  event: string
...
export type t_blocking_removed_issue_event = {
  actor: t_simple_user
  blocking: t_nullable_issue_reference
  commit_id: string | null
  commit_url: string | null
...
export type t_code_quality_finding = {
  created_at?: string | undefined
  location: t_code_quality_finding_location
  message: t_code_quality_finding_message
  number: number
  rule: t_code_quality_finding_rule
  state: "open" | "dismissed" | UnknownEnumStringValue
  url: string
}

export type t_code_quality_finding_location = {
...
export type t_code_quality_finding_message = {
  markdown: string
  text: string
}

export type t_code_quality_finding_rule = {
  category: "none" | "maintainability" | "reliability" | UnknownEnumStringValue
  description: string
  help?: string | undefined
  id: string
  severity: "error" | "warning" | "note" | "none" | UnknownEnumStringValue
  title: string
}

export type t_code_quality_setup = {
  ai_findings_option?:
    | ("disabled" | "on_push" | UnknownEnumStringValue | null)
    | undefined
  languages?:
    | (
        | "csharp"
...
export type t_code_quality_setup_update = {
  ai_findings_option?:
    | ("disabled" | "on_push" | UnknownEnumStringValue)
    | undefined
  languages?:
    | (
        | "csharp"
  ...
  | {
      ai_findings_option: "disabled" | "on_push" | UnknownEnumStringValue
    }
)
...
export type t_code_scanning_alert_instance_state =
  | "open"
  | "fixed"
  | UnknownEnumStringValue
  | null
...
export type t_code_scanning_sarifs_status = {
  analyses_url?: (string | null) | undefined
...
export type t_code_security_configuration = {
  ...
  dependabot_delegated_alert_dismissal?:
    | ("enabled" | "disabled" | "not_set" | UnknownEnumStringValue | null)
    | undefined
  ...
  secret_scanning_delegated_bypass_options?:
    | {
        reviewers?:
          | {
              mode?: ("ALWAYS" | "EXEMPT" | UnknownEnumStringValue) | undefined
              reviewer_id: number
...
export type t_code_security_default_configurations = {
  ...
  default_for_new_repos?:
    | ("public" | "private_and_internal" | "all" | UnknownEnumStringValue)
    | undefined
}[]
...
export type t_concurrency_group = {
  group_members: {
    ...
    run_name: string
    run_url: string | null
    status: "in_progress" | "pending" | UnknownEnumStringValue
  }[]
  group_name: string
  group_url: string
  total_count: number
...
export type t_copilot_space_collaborator =
  | (t_simple_user & {
      actor_type: "User"
      role: "reader" | "writer" | "admin" | UnknownEnumStringValue
    })
  | {
      actor_type: "Team"
      description?: (string | null) | undefined
...
export type t_dependabot_alert_security_advisory = {
  classification?: ("general" | "malware" | UnknownEnumStringValue) | undefined
  cve_id: string | null
  cvss: {
    score: number
    vector_string: string | null
...
export type t_discussion = {
  ...
  answer_chosen_by: {
    ...
    subscriptions_url?: string | undefined
    type?:
      | ("Bot" | "User" | "Organization" | UnknownEnumStringValue)
      | undefined
    url?: string | undefined
    user_view_type?: string | undefined
  } | null
...
export type t_fork_event = {
  ...
  forkee: {
    ...
    pull_request_creation_policy?:
      | ("all" | "collaborators_only" | UnknownEnumStringValue)
      | undefined
...
export type t_immutable_releases_organization_settings = {
  enforced_repositories: "all" | "none" | "selected" | UnknownEnumStringValue
  selected_repositories_url?: string | undefined
}
...
export type t_interaction_limit_pull_request_bypass_list = {
  users: string[]
}
...
export type t_issue_comment = {
  ...
  id: number
  issue_url: string
  minimized?: t_nullable_issue_comment_minimized | undefined
  node_id: string
  performed_via_github_app?: t_nullable_integration | undefined
...
export type t_issue_event = {
  ...
  author_association?: t_author_association | undefined
  blocked_by?: t_nullable_issue_reference | undefined
  blocking?: t_nullable_issue_reference | undefined
  commit_id: string | null
  commit_url: string | null
  created_at: string
  ...
  issue_type?: t_issue_type_webhook | undefined
  label?: t_issue_event_label | undefined
  lock_reason?: (string | null) | undefined
  milestone?: t_issue_event_milestone | undefined
  node_id: string
  parent_issue?: t_nullable_issue_reference | undefined
  performed_via_github_app?: t_nullable_integration | undefined
  prev_issue_type?: t_issue_type_webhook | undefined
  ...
  sub_issue?: t_nullable_issue_reference | undefined
  url: string
}
...
export type t_issue_event_for_issue =
  ...
  | t_issue_type_added_issue_event
  | t_issue_type_removed_issue_event
  | t_issue_type_changed_issue_event
  | t_sub_issue_added_issue_event
  | t_sub_issue_removed_issue_event
  | t_parent_issue_added_issue_event
  | t_parent_issue_removed_issue_event
  | t_blocked_by_added_issue_event
  | t_blocked_by_removed_issue_event
  | t_blocking_added_issue_event
  | t_blocking_removed_issue_event
...
export type t_issue_field = {
  ...
  updated_at?: string | undefined
  visibility?:
    | ("organization_members_only" | "all" | UnknownEnumStringValue)
    | undefined
} | null
...
export type t_issue_field_value = {
  ...
  issue_field_name?: string | undefined
...
export type t_issue_suggestion = {
  action:
    | "set_type"
    | "add_label"
    | "add_field"
  ...
  confidence: "LOW" | "MEDIUM" | "HIGH" | UnknownEnumStringValue | null
  created_at: string
  id: number
...
export type t_issue_type_added_issue_event = {
  actor: t_simple_user
  commit_id: string | null
  commit_url: string | null
  created_at: string
  ...
  id: number
  intent?: t_nullable_issue_event_intent | undefined
  issue_type: t_issue_type_webhook
  node_id: string
  performed_via_github_app: t_nullable_integration
  url: string
}

export type t_issue_type_changed_issue_event = {
  actor: t_simple_user
  commit_id: string | null
  commit_url: string | null
  created_at: string
  ...
  node_id: string
  performed_via_github_app: t_nullable_integration
  prev_issue_type: t_issue_type_webhook
  url: string
}

export type t_issue_type_removed_issue_event = {
  actor: t_simple_user
  commit_id: string | null
  commit_url: string | null
  created_at: string
...
export type t_issue_type_webhook = {
  color?:
    | (
        | "gray"
        | "blue"
...
export type t_nullable_issue_comment_minimized = {
  reason: string | null
} | null

export type t_nullable_issue_event_intent = {
  confidence?:
    | ("LOW" | "MEDIUM" | "HIGH" | UnknownEnumStringValue | null)
    | undefined
  rationale?: (string | null) | undefined
} | null

export type t_nullable_issue_reference = {
  issue_type: {
    color?: (string | null) | undefined
    id: number
    name: string
...
export type t_nullable_team_simple = {
  ...
  repositories_url: string
  slug: string
  type: "enterprise" | "organization" | UnknownEnumStringValue
  url: string
} | null

export type t_oidc_custom_property_inclusion = {
  custom_property_name: string
  inclusion_source: "organization" | "enterprise" | UnknownEnumStringValue
}
...
export type t_parent_issue_added_issue_event = {
  actor: t_simple_user
  commit_id: string | null
  commit_url: string | null
  created_at: string
  ...
  id: number
  node_id: string
  parent_issue: t_nullable_issue_reference
  performed_via_github_app: t_nullable_integration
  url: string
}

export type t_parent_issue_removed_issue_event = {
  actor: t_simple_user
  commit_id: string | null
  commit_url: string | null
  created_at: string
...
export type t_projects_v2_view = {
  ...
  html_url: string
  id: number
  layout: "table" | "board" | "roadmap" | UnknownEnumStringValue
  name: string
  node_id: string
  number: number
  project_url: string
...
export type t_pull_request = {
  ...
  stack?: t_pull_request_stack | undefined
  state: "open" | "closed" | UnknownEnumStringValue
  statuses_url: string
  title: string
  updated_at: string
...
export type t_pull_request_stack = {
  base: {
    ref: string
    sha: string
  }
...
export type t_rate_limit_overview = {
  ...
  resources: {
    ...
    copilot_usage_records?: t_rate_limit | undefined
    core: t_rate_limit
...
export type t_repository_hash_algorithm = {
  hash_algorithm: "sha1" | "sha256" | UnknownEnumStringValue
}
...
export type t_repository_rule =
  ...
  | t_repository_rule_code_scanning
  | t_repository_rule_copilot_code_review
  | t_repository_rule_license_compliance_scanning
  | t_repository_rule_file_path_restriction
  | t_repository_rule_max_file_path_length
  | t_repository_rule_file_extension_restriction
  | t_repository_rule_max_file_size
...
export type t_repository_rule_license_compliance_scanning = {
...
export type t_repository_rule_params_actor = {
  id: number
  type:
    | "User"
    | "Team"
...
export type t_repository_rule_params_dismissal_restriction = {
  allowed_actors?: t_repository_rule_params_actor[] | undefined
  enabled: boolean
}
  ...
  parameters?:
    | {
        ...
        dismissal_restriction?:
          | t_repository_rule_params_dismissal_restriction
          | undefined
...
export type t_repository_ruleset_bypass_actor = {
  ...
  actor_type:
    ...
    | UnknownEnumStringValue
  bypass_mode?:
    | ("always" | "pull_request" | "exempt" | UnknownEnumStringValue)
    | undefined
}
...
export type t_secret_scanning_alert_metadata = {
  key: string
  value: string
}[]
...
export type t_secret_scanning_alert_with_metadata = {
  assigned_to?: t_nullable_simple_user | undefined
  closure_request_comment?: (string | null) | undefined
  closure_request_reviewer?: t_nullable_simple_user | undefined
  closure_request_reviewer_comment?: (string | null) | undefined
  ...
  is_base64_encoded?: (boolean | null) | undefined
  locations_url?: string | undefined
  metadata?: t_secret_scanning_alert_metadata | undefined
  multi_repo?: (boolean | null) | undefined
  number?: t_alert_number | undefined
  provider?: (string | null) | undefined
  provider_slug?: (string | null) | undefined
...
export type t_secret_scanning_custom_pattern = {
  created_at?: string | undefined
  custom_pattern_version?: t_secret_scanning_row_version | undefined
  end_delimiter?: (string | null) | undefined
  id: number
  must_match?: (string[] | null) | undefined
  must_not_match?: (string[] | null) | undefined
  name: string
  pattern: string
  push_protection_enabled: boolean
  slug: string
  start_delimiter?: (string | null) | undefined
  state: "published" | "unpublished" | UnknownEnumStringValue
  updated_at?: string | undefined
}

export type t_secret_scanning_custom_pattern_to_create = {
...
export type t_secret_scanning_custom_pattern_to_delete = {
  custom_pattern_version?: t_secret_scanning_row_version | undefined
  pattern_id: number
}

export type t_secret_scanning_custom_pattern_to_update = {
  custom_pattern_version: t_secret_scanning_row_version
  end_delimiter?: string | undefined
  must_match?: string[] | undefined
  must_not_match?: string[] | undefined
  pattern?: string | undefined
...
export type t_secret_scanning_custom_pattern_validation_error = {
  code?:
    | (
        | "invalid"
        | "unprocessable"
...
export type t_secret_scanning_pattern_override = {
  ...
  enterprise_setting?:
    | ("not-set" | "disabled" | "enabled" | UnknownEnumStringValue | null)
    | undefined
  false_positive_rate?: number | undefined
  false_positives?: number | undefined
  setting?:
    | ("not-set" | "disabled" | "enabled" | UnknownEnumStringValue)
    | undefined
  slug?: string | undefined
  token_type?: string | undefined
}
...
export type t_sub_issue_added_issue_event = {
  actor: t_simple_user
  commit_id: string | null
  commit_url: string | null
  created_at: string
  ...
  node_id: string
  performed_via_github_app: t_nullable_integration
  sub_issue: t_nullable_issue_reference
  url: string
}

export type t_sub_issue_removed_issue_event = {
  actor: t_simple_user
  commit_id: string | null
  commit_url: string | null
  created_at: string
...
export type t_team = {
  access_source?:
    | ("direct" | "organization" | "enterprise" | UnknownEnumStringValue)
    | undefined
  description: string | null
  enterprise_id?: number | undefined
  html_url: string
...
export type t_update_budget = {
  budget: {
    ...
    budget_scope?:
      ...
      | undefined
    budget_type?: ("ProductPricing" | "SkuPricing") | undefined
    consumed_amount?: number | undefined
    id?: string | undefined
    prevent_further_usage?: boolean | undefined
    user?: string | undefined
  }
...
export type t_BillingCreateOrganizationBudgetRequestBody = {
  budget_alerting?:
    | {
        alert_recipients?: string[] | undefined
        will_alert?: boolean | undefined
  ...
  budget_scope?:
    ...
    | undefined
  budget_type?: ("BundlePricing" | "ProductPricing" | "SkuPricing") | undefined
  prevent_further_usage?: boolean | undefined
  user?: string | undefined
}
...
export type t_CopilotSpacesAddCollaboratorForOrgRequestBody = {
  ...
  actor_type: "User" | "Team" | UnknownEnumStringValue
  role: "reader" | "writer" | "admin" | UnknownEnumStringValue
}
...
export type t_CopilotSpacesCreateForOrgRequestBody = {
  base_role?:
    | ("reader" | "writer" | "admin" | "no_access" | UnknownEnumStringValue)
    | undefined
  description?: string | undefined
...
export type t_CopilotSpacesCreateForUserRequestBody = {
  base_role?: ("reader" | "no_access" | UnknownEnumStringValue) | undefined
  description?: string | undefined
  general_instructions?: string | undefined
  name: string
  resources_attributes?:
...
export type t_CopilotSpacesUpdateCollaboratorForOrgRequestBody = {
  role: "reader" | "writer" | "admin" | "no_access" | UnknownEnumStringValue
}
...
export type t_DependabotUpdateAlertRequestBody = {
  ...
  dismissed_reason?:
    ...
    | undefined
  state?: ("dismissed" | "open" | UnknownEnumStringValue) | undefined
} & (
  | {
...
export type t_EnterpriseTeamsCreateRequestBody = {
  ...
  organization_selection_type?:
    | ("disabled" | "selected" | "all" | UnknownEnumStringValue)
    | undefined
  sync_to_organizations?:
    | ("all" | "disabled" | UnknownEnumStringValue)
    | undefined
}
...
export type t_GistsCreateRequestBody = {
  ...
  >
  public?: (boolean | "true" | "false" | UnknownEnumStringValue) | undefined
}
...
export type t_GitCreateTreeRequestBody = {
  ...
  tree: {
    ...
    path?: string | undefined
    sha?: (string | null) | undefined
    type?: ("blob" | "tree" | "commit" | UnknownEnumStringValue) | undefined
  }[]
}
...
export type t_HostedComputeCreateNetworkConfigurationForOrgRequestBody = {
  compute_service?: ("none" | "actions" | UnknownEnumStringValue) | undefined
  failover_network_enabled?: boolean | undefined
  failover_network_settings_ids?: string[] | undefined
  name: string
...
export type t_InteractionsUpdatePullRequestCreationCapForRepoRequestBody = {
  enabled: boolean
...
export type t_IssuesAddAssigneesRequestBody = {
  assignees?:
    | (
        ...
        | {
            confidence?:
              | ("low" | "medium" | "high" | UnknownEnumStringValue)
              | undefined
            login: string
...
export type t_MigrationsStartImportRequestBody = {
  tfvc_project?: string | undefined
  vcs?:
    | ("subversion" | "git" | "mercurial" | "tfvc" | UnknownEnumStringValue)
    | undefined
...
export type t_MigrationsUpdateImportRequestBody = {
  tfvc_project?: string | undefined
  vcs?:
    | ("subversion" | "tfvc" | "git" | "mercurial" | UnknownEnumStringValue)
    | undefined
  vcs_password?: string | undefined
  vcs_username?: string | undefined
} | null
...
export type t_OrgsCreateArtifactDeploymentRecordRequestBody = {
  ...
  runtime_risks?:
    ...
    | undefined
  status: "deployed" | "decommissioned" | UnknownEnumStringValue
  tags?: Record<string, string> | undefined
  version?: string | undefined
}
...
export type t_OrgsCreateArtifactStorageRecordRequestBody = {
  ...
  repository?: string | undefined
  return_records?: boolean | undefined
  status?: ("active" | "eol" | "deleted" | UnknownEnumStringValue) | undefined
  version?: string | undefined
}
...
export type t_OrgsSetClusterDeploymentRecordsRequestBody = {
  deployments: {
    ...
    runtime_risks?:
      ...
      | undefined
    status?:
      | ("deployed" | "decommissioned" | UnknownEnumStringValue)
      | undefined
    tags?: Record<string, string> | undefined
    version?: string | undefined
  }[]
  logical_environment: string
  partial_success?: boolean | undefined
  physical_environment?: string | undefined
  return_records?: boolean | undefined
}
...
export type t_ProjectsAddFieldForOrgRequestBody =
  ...
  | {
      data_type: "text" | "number" | "date" | UnknownEnumStringValue
      name: string
    }
  | {
...
export type t_ProjectsAddItemForOrgRequestBody = {
  ...
  type: "Issue" | "PullRequest" | UnknownEnumStringValue
} & (
  | {
      id: number
    }
...
export type t_PullsCreateReviewCommentRequestBody = {
  ...
  side?: ("LEFT" | "RIGHT" | UnknownEnumStringValue) | undefined
  start_line?: number | undefined
  start_side?: ("LEFT" | "RIGHT" | "side" | UnknownEnumStringValue) | undefined
  subject_type?: ("line" | "file" | UnknownEnumStringValue) | undefined
}
...
export type t_ReposCreatePagesSiteRequestBody =
  | (({
      build_type?: ("legacy" | "workflow" | UnknownEnumStringValue) | undefined
      source?:
        | {
            branch: string
...
export type t_ReposCreateRepoRulesetRequestBody = {
  ...
  name: string
  rules?: t_repository_rule[] | undefined
  target?: ("branch" | "tag" | "push" | UnknownEnumStringValue) | undefined
}
        ...
        secret_scanning_delegated_bypass_options?:
          | {
              reviewers?:
                | {
                    mode?:
                      | ("ALWAYS" | "EXEMPT" | UnknownEnumStringValue)
                      | undefined
                    reviewer_id: number
                    reviewer_type: "TEAM" | "ROLE" | UnknownEnumStringValue
                  }[]
...
export type t_SecretScanningBulkCreateOrgCustomPatternsRequestBody = {
  patterns: t_secret_scanning_custom_pattern_to_create[]
}

export type t_SecretScanningBulkCreateRepoCustomPatternsRequestBody = {
  patterns: t_secret_scanning_custom_pattern_to_create[]
}

export type t_SecretScanningBulkDeleteOrgCustomPatternsRequestBody = {
  patterns: t_secret_scanning_custom_pattern_to_delete[]
  post_delete_action?:
    | ("delete_alerts" | "resolve_alerts" | UnknownEnumStringValue)
    | undefined
}

export type t_SecretScanningBulkDeleteRepoCustomPatternsRequestBody = {
  patterns: t_secret_scanning_custom_pattern_to_delete[]
  post_delete_action?:
    | ("delete_alerts" | "resolve_alerts" | UnknownEnumStringValue)
    | undefined
...
export type t_SecretScanningUpdateAlertRequestBody = {
  ...
  state?: t_secret_scanning_alert_state | undefined
  validity?: ("active" | "inactive" | UnknownEnumStringValue | null) | undefined
} & (
  | {
  ...
  | {
      validity: "active" | "inactive" | UnknownEnumStringValue | null
    }
)
...
export type t_TeamsAddOrUpdateRepoPermissionsLegacyRequestBody = {
  permission?: ("pull" | "push" | "admin" | UnknownEnumStringValue) | undefined
}
