    ...
    async (req: Request, res: Response, next: NextFunction) => {
      try {
        ...
        await sendResponse(
          ...
          status,
          body,
          getServiceStatusResponseBodyValidator,
        )
      } catch (error) {
        next(error)
      }
    ...
    async (req: Request, res: Response, next: NextFunction) => {
      try {
        ...
        await sendResponse(
          ...
          status,
          body,
          widgetsGetWidgetResponseBodyValidator,
        )
      } catch (error) {
        next(error)
      }
    ...
    async (req: Request, res: Response, next: NextFunction) => {
      try {
        ...
        await sendResponse(
          ...
          status,
          body,
          widgetsListWidgetsResponseBodyValidator,
        )
      } catch (error) {
        next(error)
      }
    ...
    async (req: Request, res: Response, next: NextFunction) => {
      try {
        ...
        await sendResponse(
          ...
          status,
          body,
          widgetsGetAnalyticsResponseBodyValidator,
        )
      } catch (error) {
        next(error)
      }
    ...
    async (req: Request, res: Response, next: NextFunction) => {
      try {
        ...
        await sendResponse(
          ...
          status,
          body,
          widgetsUpdateAnalyticsResponseBodyValidator,
        )
      } catch (error) {
        next(error)
      }
    ...
    async (req: Request, res: Response, next: NextFunction) => {
      try {
        ...
        await sendResponse(
          ...
          status,
          body,
          widgetsGetRepairStatusResponseBodyValidator,
        )
      } catch (error) {
        next(error)
      }
    ...
    async (req: Request, res: Response, next: NextFunction) => {
      try {
        ...
        await sendResponse(
          ...
          status,
          body,
          widgetPartsGetWidgetPartResponseBodyValidator,
        )
      } catch (error) {
        next(error)
      }
